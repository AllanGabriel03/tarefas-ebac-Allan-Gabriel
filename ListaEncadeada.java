...
public class ListaEncadeada {
	...
	public static void main(String[] args) {
		...
		ListaLigada listaligada = le.new ListaLigada();
		
		
		listaligada.inserirNoFinal(1);
		listaligada.inserirNoFinal(2);
		listaligada.inserirNoFinal(3);
		listaligada.inserirNoFinal(4);
		listaligada.inserirNaPosicao(1, 5);
		listaligada.removerNaPosicao(1);
		listaligada.removerNoFinal();
